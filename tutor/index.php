...
$PAGE->https_required();
$PAGE->set_url('/sct/tutor/index.php');
...
<header>
    <div class="row">
        ...
        <div class="col-sm-6 text-right h2">
            <a class="btn btn-primary" href="add.php"><i class="fa fa-plus"></i> Novo Tutor(a)</a>
...
<table class="table table-hover">
    ...
    <tr>
        <td><?php echo $tutor['tutor']; ?></td>
        <td><?php echo $tutor['curso']; ?></td>
        <td><?php echo $tutor['polo']; ?></td>
        <td><?php echo $tutor['tipo']; ?></td>
        <td class="actions text-right">
            <a href="view.php?id=<?php echo $tutor['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i></a>
